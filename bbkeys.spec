...
zaprojektowanym dla zarządcy okien blackbox, napisanego przez Brada
Hughesa. Bazuje na kodzie obiektowym bbtools napisanym przez Johna
Kennisa, używa także niektórych klas blackboksa. bbkeys są łatwo
konfigurowalne przez bezpośrednią edycję pliku użytkownika
